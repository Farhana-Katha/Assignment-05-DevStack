...
const Banner = () => {
    return (
        <header className='w-full bg-white text-slate-900 items-center py-8'>
            <div className='max-w-7xl mx-auto lg:px-8 flex  items-start '>
            <div >
                ...
                <span className="bg-clip-text text-transparent bg-linear-to-r from-pink-500 via bg-purple-600 to-indigo-600"> Development Stack</span>
                </h1>
                ...
                <button className="btn btn-secondary text-shadow-transparent bg-linear-to-r from-pink-500 via bg-purple-600 to-indigo-600">Explore Technologies</button>
